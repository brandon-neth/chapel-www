...
id="source"
description="""
To download and install Chapel from source, download **[chapel-2.6.0.tar.gz](https://github.com/chapel-lang/chapel/releases/download/2.6.0/chapel-2.6.0.tar.gz)** from [GitHub](https://github.com/chapel-lang/chapel/releases/tag/2.6.0), then unpack and build it as described in the [Quickstart instructions](https://chapel-lang.org/docs/usingchapel/QUICKSTART.html).
"""
